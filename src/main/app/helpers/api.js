...
module.exports.sendResponse = (response, status, success, type, message, data) => {
...
module.exports.sendUnauthorizedResponse = (response) => {
    ...
    this.sendResponse(response, codes.UNAUTHORIZED, false, 'UNAUTHORIZED', "Unauthorized acess");
}