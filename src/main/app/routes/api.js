...
router.delete(
  "/wallets/:id/transactions/:txnid/release",
  TransctionController.release
);
router.patch(
  "/wallets/:id/transactions/:txnid/complete",
  TransctionController.complete
);
...
router.get(
  ...
  TransctionController.searchTransaction
);
